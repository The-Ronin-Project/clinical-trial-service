...
@Component
class ClinicalTrialAuthenticationService(
    private val client: HttpClient,
    @Value("\${clinicaltrial.auth.token.url}")
    private val authTokenUrl: String,
    @Value("\${clinicaltrial.auth.audience}")
    private val audience: String,
    @Value("\${clinicaltrial.auth.client.id}")
    private val authClientId: String,
    @Value("\${clinicaltrial.auth.client.secret}")
    private val authClientSecret: String,
    @Value("\${clinicaltrial.auth.auth0:true}")
