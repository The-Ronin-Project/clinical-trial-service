...
class RCDMObservationToCTDMObservationTest {
    ...
    private val rcdmHelper =
        mockk<BaseRCDMToCTDMHelper> {
            every { setProfileMeta("Body Temperature Noninvasive") } returns
                meta {
            ...
            every { setProfileMeta("Heart Rate Noninvasive") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Blood Pressure Panel") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Respiratory Rate Without Provocation") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Oxygen Saturation (SpO2) by Pulse Oximetry") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Body Height") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Body Weight") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Body Mass Index Ratio (BMI)") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Body Surface Area (BSA)") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
            ...
            every { setProfileMeta("Hemoglobin (HGB) in Blood") } returns
                meta {
                    profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
                    tag of
                        listOf(
        ...
        val exception =
            assertThrows<Exception> {
                RCDMObservationToCTDMObservation(
                    ...
                    dataDictionaryService,
                    rcdmHelper,
                ).rcdmObservationToCTDMObservation("test-notfhirId", rcdmObservation)
            }
