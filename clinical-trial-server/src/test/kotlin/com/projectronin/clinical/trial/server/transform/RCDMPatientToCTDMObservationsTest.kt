...
class RCDMPatientToCTDMObservationsTest {
    ...
    private val rcdmHelper = mockk<BaseRCDMToCTDMHelper> {
        every { setProfileMeta("Birth Date") } returns meta {
        ...
        every { setProfileMeta("Sex") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
                    system of "SexUUID"
        ...
        every { setProfileMeta("Marital Status") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Multiple Birth") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Communication Language") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Religion") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Birth Sex Observation") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Gender Identity") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Ethnicity") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
        ...
        every { setProfileMeta("Race") } returns meta {
            profile of listOf(Canonical("https://projectronin.io/fhir/StructureDefinition/CTDM-Observation"))
            tag of listOf(
                coding {
                    system of "RaceUUID"
    ...
    val roninFhir = Identifier(
        system = CodeSystem.RONIN_FHIR_ID.uri,
        value = "fhirId".asFHIR(),
        type = CodeableConcepts.RONIN_FHIR_ID
    )

    val roninFhir2 = Identifier(
        system = CodeSystem.RONIN_FHIR_ID.uri,
            ...
            extension of listOf(
                ...
                extension {
                    ...
                    extension of listOf(
                        extension {
                            url of "ombCategory"
                            value of DynamicValues.codeableConcept(
                                CodeableConcept(
                                    coding = listOf(
                                        Coding(
