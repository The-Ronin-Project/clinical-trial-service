...
internal class DataDictionaryServiceTest {
    ...
    private val service = DataDictionaryService(ociClient, "7")
    ...
    fun `retry works`() {
        every {
            ociClient.getObjectFromINFX("Registries/v1/data dictionary/prod/38efb390-497f-4b49-9619-a45d33048a3a/6.csv")
        } throws Exception()
        service.load("6")
        every {
            ociClient.getObjectFromINFX("Registries/v1/data dictionary/prod/38efb390-497f-4b49-9619-a45d33048a3a/6.csv")
